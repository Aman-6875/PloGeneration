...
<head>
        ...
        <meta charset="utf-8" />
        <title>Register | ThemeFisher - Admin & Dashboard</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p>Get your free Admin account now.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <div>
                                ...
                                <p>© <script>document.write(new Date().getFullYear())</script> ThemeFisher. Crafted with <i class="mdi mdi-heart text-danger"></i> by ThemeFisher</p>
                            </div>
                        </div>
